...
import {
  ...
  type GetProposalsPaidLeaveExportParams,
...
type ExportParams = NonNullable<GetProposalsPaidLeaveExportParams>
...
type ProposalFilterParams = Partial<GetProposalsPaidLeaveParams> & {
...
export function useProposalPaidLeaveExport() {
  const { openExportDialog: baseOpenExportDialog, isExporting } = useExport<
    NonNullable<GetProposalsPaidLeaveExportParams>
  >({
    exportFunction: (params) => getProposalLeaveService().exportProposalsPaidLeave(params),
    defaultFilename: 'proposals-paid-leave.xlsx',
  })

  const openExportDialog = useCallback(
    async (searchQuery: string, filterParams: ProposalFilterParams) => {
      const exportParams: GetProposalsPaidLeaveExportParams = {
        async: true,
