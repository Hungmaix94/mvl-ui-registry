...
import {
  ...
  type GetProposalsBulkJobTransferExportParams,
...
type ExportParams = NonNullable<GetProposalsBulkJobTransferExportParams>
...
type ProposalFilterParams = Partial<GetProposalsBulkJobTransferParams> & {
...
export function useProposalBulkJobTransferExport() {
  const { openExportDialog: baseOpenExportDialog, isExporting } = useExport<
    NonNullable<GetProposalsBulkJobTransferExportParams>
  >({
    exportFunction: (params) => getProposalMiscService().exportProposalsBulkJobTransfer(params),
    defaultFilename: 'proposals-bulk-job-transfer.xlsx',
  })

  const openExportDialog = useCallback(
    async (searchQuery: string, filterParams: ProposalFilterParams) => {
      const exportParams: GetProposalsBulkJobTransferExportParams = {
        async: true,
