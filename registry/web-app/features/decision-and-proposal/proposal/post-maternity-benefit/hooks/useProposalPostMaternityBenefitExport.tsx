...
import {
  ...
  type GetProposalsPostMaternityBenefitsExportParams,
...
type ExportParams = NonNullable<GetProposalsPostMaternityBenefitsExportParams>
...
type ProposalFilterParams = Partial<GetProposalsPostMaternityBenefitsParams> & {
...
export function useProposalPostMaternityBenefitExport() {
  const { openExportDialog: baseOpenExportDialog, isExporting } = useExport<
    NonNullable<GetProposalsPostMaternityBenefitsExportParams>
  >({
    exportFunction: (params) =>
      getProposalLeaveService().exportProposalsPostMaternityBenefits(params),
    defaultFilename: 'proposals-post-maternity-benefits.xlsx',
  })

  const openExportDialog = useCallback(
    async (searchQuery: string, filterParams: ProposalFilterParams) => {
      const exportParams: GetProposalsPostMaternityBenefitsExportParams = {
        async: true,
