...
import {
  ...
  type GetProposalsReturnToWorkExportParams,
...
type ExportParams = NonNullable<GetProposalsReturnToWorkExportParams>
...
type ProposalFilterParams = Partial<GetProposalsReturnToWorkParams> & {
...
export function useProposalReturnToWorkExport() {
  const { openExportDialog: baseOpenExportDialog, isExporting } = useExport<
    NonNullable<GetProposalsReturnToWorkExportParams>
  >({
    exportFunction: (params) => getProposalMiscService().exportProposalsReturnToWork(params),
    defaultFilename: 'proposals-return-to-work.xlsx',
  })

  const openExportDialog = useCallback(
    async (searchQuery: string, filterParams: ProposalFilterParams) => {
      const exportParams: GetProposalsReturnToWorkExportParams = {
        async: true,
