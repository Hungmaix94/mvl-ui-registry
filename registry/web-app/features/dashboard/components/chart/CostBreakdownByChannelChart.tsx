...
import { useCostBreakdownByChannel } from '@/services'
...
type CostBreakdownByChannelChartProps = { compact?: boolean }

function CostBreakdownByChannelChart({ compact }: CostBreakdownByChannelChartProps = {}) {
  ...
  const { data: apiData, isLoading } = useCostBreakdownByChannel(apiParams)
  ...
  const handleDownloadChart = async () => {
    ...
    await exportElementToPdf(chartRef.current, {
      fileName: 'bieu-do-chi-phi-theo-kenh.pdf',
      overlayMessage: 'Đang tạo biểu đồ Chi phí theo kênh...',
    })
  }
  ...
  return (
    <div
      ...
      data-api={ApiPaths.hrm_dashboard_charts_cost_breakdown_by_channel_retrieve}
    >
      <DashboardChartTitle
        reportLink={APP_PATH.REPORT_RECRUITMENT_CHANNEL}
...
export default CostBreakdownByChannelChart
