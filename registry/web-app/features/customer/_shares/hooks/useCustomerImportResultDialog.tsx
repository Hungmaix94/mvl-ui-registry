...
import type { CustomerImportResult } from '@/types/customer-import.ts'
import type { ImportJob } from '@/services/export-service.ts'
import type { DialogConfig } from '@/types'
import CustomerImportResultContent from '@/features/customer/_shares/components/CustomerImportResultContent.tsx'
...
export function useCustomerImportResultDialog() {
  ...
  const loadResultFiles = useCallback(async (rawFiles: ResultFiles | string | null | undefined) => {
    ...
    const parsedResult: CustomerImportResult = {
  ...
  const handleClose = useCallback(() => {
    ...
    invalidateByPrefix('sales/customers')
  }, [invalidateByPrefix])
