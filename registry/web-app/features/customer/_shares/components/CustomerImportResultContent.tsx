...
import type {
  ...
  ImportParsedResult,
  ImportResultRecord,
} from '@/types/customer-import.ts'
import { Flex } from '@radix-ui/themes'

export type CustomerImportResultContentProps = {
...
const CustomerImportResultContent = ({
  result,
  activeTab,
  onTabChange,
  onCopyFailure,
  isLoading,
}: CustomerImportResultContentProps) => {
...
export default CustomerImportResultContent
