...
type RecalculateProgressDialogProps = {
  progress: number
...
export default function RecalculateProgressDialog(props: RecalculateProgressDialogProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-9 px-6 py-20">
      ...
      <div className="flex w-full flex-col items-end gap-5 text-center">
        {status === 'failure' ? (
          <>
            <p className="typo-h4 text-content-dark-1 w-full">Tính lại lương thất bại</p>
            <p className="typo-body-lg-regular text-content-dark-3 w-full">
              {error || 'Đã xảy ra lỗi khi tính lại lương'}
            </p>
          </>
        ) : status === 'success' ? (
          <>
            <p className="typo-h4 text-content-dark-1 w-full">Tính lại lương thành công</p>
            <p className="typo-body-lg-regular text-content-dark-3 w-full">
              Dữ liệu lương đã được cập nhật
            </p>
          </>
        ) : (
          <>
            <p className="typo-h4 text-content-dark-1 w-full">Đang tính lại lương...</p>
            <p className="typo-body-lg-regular text-content-dark-3 w-full">
