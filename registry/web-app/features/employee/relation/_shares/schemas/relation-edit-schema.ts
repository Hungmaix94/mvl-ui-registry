...
/**
 * Zod schema for relation edit form validation
 *
 * Field names match API schema (snake_case):
 * - employee_id (not employee)
 */
export const relationEditSchema = z.object({
...
export type RelationEditFormInput = z.input<typeof relationEditSchema>
// Output type for API (after transform)
export type RelationEditFormData = z.output<typeof relationEditSchema>
