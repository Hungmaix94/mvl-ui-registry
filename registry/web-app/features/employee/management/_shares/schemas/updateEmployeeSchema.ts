...
export const updateEmployeeSchema = z.object({
  ...
  // Note: code_type, username, email are included but will be disabled in UI
  code_type: z.nativeEnum(EmployeeCodeType).optional(),
  fullname: z
...
export type UpdateEmployeeFormData = z.output<typeof updateEmployeeSchema>
