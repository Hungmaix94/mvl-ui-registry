...
/**
 * Zod schema for dependent edit form validation
 *
 * Field names match API schema (snake_case):
 * - employee_id (not employee)
 */
export const dependentEditSchema = z.object({
...
export type DependentEditFormInput = z.input<typeof dependentEditSchema>
// Output type for API (after transform)
export type DependentEditFormData = z.output<typeof dependentEditSchema>
