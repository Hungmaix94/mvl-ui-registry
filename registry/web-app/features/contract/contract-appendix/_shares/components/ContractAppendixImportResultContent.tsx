...
import type {
  ContractAppendixImportResult,
  ImportParsedResult,
  ImportResultRecord,
} from '@/types/contract-appendix-import.ts'
import { Flex } from '@radix-ui/themes'

export type ContractAppendixImportResultContentProps = {
  result: ContractAppendixImportResult
...
const ContractAppendixImportResultContent = ({
  result,
  activeTab,
  onTabChange,
  onCopyFailure,
  isLoading,
}: ContractAppendixImportResultContentProps) => {
...
export default ContractAppendixImportResultContent
