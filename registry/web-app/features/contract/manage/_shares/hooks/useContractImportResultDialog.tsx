...
import type { ContractImportResult } from '@/types/contract-import.ts'
import type { ImportJob } from '@/services/export-service.ts'
import type { DialogConfig } from '@/types'
import ContractImportResultContent from '@/features/contract/manage/_shares/components/ContractImportResultContent.tsx'
...
export function useContractImportResultDialog() {
  ...
  const loadResultFiles = useCallback(async (rawFiles: ResultFiles | string | null | undefined) => {
    ...
    const parsedResult: ContractImportResult = {
  ...
  const handleClose = useCallback(() => {
    ...
    invalidateByPrefix('hrm/contracts')
  }, [invalidateByPrefix])
