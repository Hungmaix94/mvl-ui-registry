...
import RecruitmentRequestImportResultContent from '@/features/recruitment/request/_shares/components/RecruitmentRequestImportResultContent.tsx'
...
export function useRecruitmentRequestImportResultDialog() {
  ...
  const handleClose = useCallback(() => {
    ...
    invalidateByPrefix('hrm/recruitment-requests')
  }, [invalidateByPrefix])
  ...
  const createConfig = useCallback((): DialogConfig => {
    return {
      ...
      content: result ? (
        <RecruitmentRequestImportResultContent
          result={result}
          activeTab={activeTab}
