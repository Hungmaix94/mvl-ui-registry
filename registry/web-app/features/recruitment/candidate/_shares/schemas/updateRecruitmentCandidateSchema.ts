...
export const updateRecruitmentCandidateSchema = z
  .object({
    name: z.string().min(1, 'Tên ứng viên là bắt buộc').max(100),
    citizen_id: z
...
export type UpdateRecruitmentCandidateFormData = z.infer<typeof updateRecruitmentCandidateSchema>
