...
export type ContactPersonFormFieldDialogSavePayload = {
  employee_id: number
  code: string
  fullname: string
...
export type ContactPersonFormFieldDialogInitialValues = {
  employee_id: number
  code?: string
  fullname?: string
  department_name?: string
...
type ContactPersonFormFieldDialogProps = {
  mode?: 'add' | 'edit'
  initialValues?: ContactPersonFormFieldDialogInitialValues
  onSave: (payload: ContactPersonFormFieldDialogSavePayload) => void
}
...
export function ContactPersonFormFieldDialog({
  mode = 'add',
  initialValues,
  onSave,
}: ContactPersonFormFieldDialogProps) {
