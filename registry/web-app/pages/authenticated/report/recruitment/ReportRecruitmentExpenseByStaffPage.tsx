...
import ReportRecruitmentExpenseByStaffTable from '@/features/report/recruitment/expense/view/ReportRecruitmentExpenseByStaffTable'
...
import {
  type GetCostByPayerReportParams,
  useCostByPayerReport,
  useExportCostByPayerReport,
...
): GetCostByPayerReportParams {
  const params: GetCostByPayerReportParams = {}
...
const ReportRecruitmentExpenseByStaffPage = () => {
  ...
  const { data, isLoading } = useCostByPayerReport(apiParams, {
  ...
  // Export is generated server-side (styled XLSX) via the cost-by-payer export endpoint.
  const { openExportDialog } = useExportCostByPayerReport()
      ...
      <Flex flexGrow="1" direction="column" gap="0" className="pb-6">
        ...
        >
          <div ref={tableWrapperRef} className="min-w-0">
            <ReportRecruitmentExpenseByStaffTable
              data={data}
...
export default ReportRecruitmentExpenseByStaffPage
