...
import DeviceChangeTable from '@/features/decision-and-proposal/proposal/device-change/view/DeviceChangeTable.tsx'
import {
  useProposalsDeviceChange,
  type GetProposalsDeviceChangeParams,
...
import { useProposalDeviceChangeExport } from '@/features/decision-and-proposal/proposal/device-change/hooks/useProposalDeviceChangeExport.tsx'
...
): NonNullable<GetProposalsDeviceChangeParams> {
  const params: NonNullable<GetProposalsDeviceChangeParams> = {}
...
export default function ProposalDeviceChangePage() {
  ...
  const { openExportDialog } = useProposalDeviceChangeExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsDeviceChange(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_device_change') ? handleExport : undefined
        }
      />
