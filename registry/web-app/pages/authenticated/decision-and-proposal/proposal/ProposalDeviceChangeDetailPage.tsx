...
export default function ProposalDeviceChangeDetailPage() {
  ...
  const handleShowHistory = useCallback(() => {
    if (proposalId && proposalId > 0) {
      const path = APP_PATH.PROPOSAL_DEVICE_CHANGE_HISTORY.replace(':id', proposalId.toString())
      navigate(path)
    }
  }, [navigate, proposalId])
  ...
  return (
    <>
      ...
      <DetailPageWrapper
        ...
        isError={isError}
        hasPermission={ability.can('retrieve', 'proposal_device_change')}
      >
        {proposal && (
          <Flex direction="column" gap="6" className="px-10 py-6">
            ...
            <ProposalTypeInfo proposalType={ProposalType.device_change} proposal={proposal} />
