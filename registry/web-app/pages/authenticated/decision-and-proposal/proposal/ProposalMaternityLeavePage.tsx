...
import MaternityLeaveTable from '@/features/decision-and-proposal/proposal/maternity-leave/view/MaternityLeaveTable.tsx'
import {
  useProposalsMaternityLeave,
  type GetProposalsMaternityLeaveParams,
...
import { useProposalMaternityLeaveExport } from '@/features/decision-and-proposal/proposal/maternity-leave/hooks/useProposalMaternityLeaveExport.tsx'
...
): NonNullable<GetProposalsMaternityLeaveParams> {
  const params: NonNullable<GetProposalsMaternityLeaveParams> = {}
...
export default function ProposalMaternityLeavePage() {
  ...
  const { openExportDialog } = useProposalMaternityLeaveExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsMaternityLeave(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_maternity_leave') ? handleExport : undefined
        }
      />
