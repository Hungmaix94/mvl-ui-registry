...
export default function ProposalOvertimeWorkDetailPage() {
  ...
  const handleShowHistory = useCallback(() => {
    if (proposalId && proposalId > 0) {
      const path = APP_PATH.PROPOSAL_OVERTIME_WORK_HISTORY.replace(':id', proposalId.toString())
      navigate(path)
    }
  }, [navigate, proposalId])
  ...
  return (
    <>
      ...
      <DetailPageWrapper
        ...
        isError={isError}
        hasPermission={ability.can('retrieve', 'proposal_overtime_work')}
      >
        {proposal && (
          <Flex direction="column" gap="6" className="px-10 py-6">
            ...
            <ProposalTypeInfo proposalType={ProposalType.overtime_work} proposal={proposal} />
