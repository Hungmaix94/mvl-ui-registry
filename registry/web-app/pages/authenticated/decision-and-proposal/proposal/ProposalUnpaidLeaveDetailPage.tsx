...
export default function ProposalUnpaidLeaveDetailPage() {
  ...
  const handleShowHistory = useCallback(() => {
    if (proposalId && proposalId > 0) {
      const path = APP_PATH.PROPOSAL_UNPAID_LEAVE_HISTORY.replace(':id', proposalId.toString())
      navigate(path)
    }
  }, [navigate, proposalId])
  ...
  return (
    <>
      ...
      <DetailPageWrapper
        ...
        isError={isError}
        hasPermission={ability.can('retrieve', 'proposal_unpaid_leave')}
      >
        {proposal && (
          <Flex direction="column" gap="6" className="px-10 py-6">
            ...
            <ProposalTypeInfo proposalType={ProposalType.unpaid_leave} proposal={proposal} />
