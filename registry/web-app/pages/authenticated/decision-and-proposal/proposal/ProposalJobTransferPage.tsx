...
import JobTransferTable from '@/features/decision-and-proposal/proposal/job-transfer/view/JobTransferTable.tsx'
import {
...
import { useProposalJobTransferExport } from '@/features/decision-and-proposal/proposal/job-transfer/hooks/useProposalJobTransferExport.tsx'
...
): NonNullable<GetProposalsJobTransferParams> {
  const params: NonNullable<GetProposalsJobTransferParams> = {}
...
export default function ProposalJobTransferPage() {
  ...
  const { openExportDialog } = useProposalJobTransferExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsJobTransfer(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_job_transfer') ? handleExport : undefined
        }
      />
