...
import PaidLeaveTable from '@/features/decision-and-proposal/proposal/paid-leave/view/PaidLeaveTable.tsx'
import {
  useProposalsPaidLeave,
  type GetProposalsPaidLeaveParams,
...
import { useProposalPaidLeaveExport } from '@/features/decision-and-proposal/proposal/paid-leave/hooks/useProposalPaidLeaveExport.tsx'
...
): NonNullable<GetProposalsPaidLeaveParams> {
  const params: NonNullable<GetProposalsPaidLeaveParams> = {}
...
export default function ProposalPaidLeavePage() {
  ...
  const { openExportDialog } = useProposalPaidLeaveExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsPaidLeave(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_paid_leave') ? handleExport : undefined
        }
      />
