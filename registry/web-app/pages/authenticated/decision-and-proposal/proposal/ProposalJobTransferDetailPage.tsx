...
export default function ProposalJobTransferDetailPage() {
  ...
  const handleShowHistory = useCallback(() => {
    if (proposalId && proposalId > 0) {
      const path = APP_PATH.PROPOSAL_JOB_TRANSFER_HISTORY.replace(':id', proposalId.toString())
      navigate(path)
    }
  }, [navigate, proposalId])
  ...
  return (
    <>
      ...
      <DetailPageWrapper
        ...
        isError={isError}
        hasPermission={ability.can('retrieve', 'proposal_job_transfer')}
      >
        {proposal && (
          <Flex direction="column" gap="6" className="px-10 py-6">
            ...
            <ProposalTypeInfo proposalType={ProposalType.job_transfer} proposal={proposal} />
