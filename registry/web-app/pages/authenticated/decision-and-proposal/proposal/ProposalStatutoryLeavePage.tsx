...
import StatutoryLeaveTable from '@/features/decision-and-proposal/proposal/statutory-leave/view/StatutoryLeaveTable.tsx'
import {
  useProposalsStatutoryLeave,
...
import { useProposalStatutoryLeaveExport } from '@/features/decision-and-proposal/proposal/statutory-leave/hooks/useProposalStatutoryLeaveExport.tsx'
...
): NonNullable<GetProposalsStatutoryLeaveParams> {
  const params: NonNullable<GetProposalsStatutoryLeaveParams> = {}
...
export default function ProposalStatutoryLeavePage() {
  ...
  const { openExportDialog } = useProposalStatutoryLeaveExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsStatutoryLeave(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_statutory_leave') ? handleExport : undefined
        }
      />
