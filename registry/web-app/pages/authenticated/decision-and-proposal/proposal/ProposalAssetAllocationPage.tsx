...
import AssetAllocationTable from '@/features/decision-and-proposal/proposal/asset-allocation/view/AssetAllocationTable.tsx'
import {
  useProposalsAssetAllocation,
  type GetProposalsAssetAllocationParams,
...
import { useProposalAssetAllocationExport } from '@/features/decision-and-proposal/proposal/asset-allocation/hooks/useProposalAssetAllocationExport.tsx'
...
): NonNullable<GetProposalsAssetAllocationParams> {
  const params: NonNullable<GetProposalsAssetAllocationParams> = {}
...
export default function ProposalAssetAllocationPage() {
  ...
  const { openExportDialog } = useProposalAssetAllocationExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsAssetAllocation(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_asset_allocation') ? handleExport : undefined
        }
      />
