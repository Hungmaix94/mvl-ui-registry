...
export default function ProposalPaidLeaveDetailPage() {
  ...
  const handleShowHistory = useCallback(() => {
    if (proposalId && proposalId > 0) {
      const path = APP_PATH.PROPOSAL_PAID_LEAVE_HISTORY.replace(':id', proposalId.toString())
      navigate(path)
    }
  }, [navigate, proposalId])
  ...
  return (
    <>
      ...
      <DetailPageWrapper
        ...
        isError={isError}
        hasPermission={ability.can('retrieve', 'proposal_paid_leave')}
      >
        {proposal && (
          <Flex direction="column" gap="6" className="px-10 py-6">
            ...
            <ProposalTypeInfo proposalType={ProposalType.paid_leave} proposal={proposal} />
