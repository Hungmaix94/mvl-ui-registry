...
import UnpaidLeaveTable from '@/features/decision-and-proposal/proposal/unpaid-leave/view/UnpaidLeaveTable.tsx'
import {
  useProposalsUnpaidLeave,
  type GetProposalsUnpaidLeaveParams,
...
import { useProposalUnpaidLeaveExport } from '@/features/decision-and-proposal/proposal/unpaid-leave/hooks/useProposalUnpaidLeaveExport.tsx'
...
): NonNullable<GetProposalsUnpaidLeaveParams> {
  const params: NonNullable<GetProposalsUnpaidLeaveParams> = {}
...
export default function ProposalUnpaidLeavePage() {
  ...
  const { openExportDialog } = useProposalUnpaidLeaveExport()
  ...
  const {
    ...
    isFetching,
    isRefetching,
  } = useProposalsUnpaidLeave(apiParams, {
  ...
  return (
    <>
      <PageTitle
        ...
        handleExportBtnFull={
          ability.can('export', 'proposal_unpaid_leave') ? handleExport : undefined
        }
      />
