...
interface ReceiptVoucherHistoryTabProps {
  historiesData: any
  isLoadingHistories: boolean
}

export const ReceiptVoucherHistoryTab = ({
  historiesData,
  isLoadingHistories,
}: ReceiptVoucherHistoryTabProps) => {
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-content-dark-3 mt-1 text-xs">
          Theo dõi toàn bộ lịch sử tác động, thay đổi trạng thái và người thao tác trên phiếu thu
          này.
        </p>
      </div>
        ...
        {isLoadingHistories ? (
          ...
          <div className="border-border-1 bg-background-2 rounded-xl border border-dashed p-10 text-center">
            ...
            <p className="text-content-dark-3 mt-3 text-sm font-semibold">
              Chưa có lịch sử cập nhật nào được ghi nhận cho phiếu thu này
            </p>
          </div>
        )}
      </div>
