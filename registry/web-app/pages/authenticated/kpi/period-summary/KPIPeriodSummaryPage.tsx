...
import KPIPeriodSummaryTable from '@/features/kpi/kpi-period-summary/view/KPIPeriodSummaryTable'
...
const KPIPeriodSummaryPage = () => {
  ...
  return (
    <>
      <PageTitle />
      <Flex flexGrow={'1'} direction="column" gap="4" className="pt-5 pb-6">
        <KPIPeriodSummaryTable
          data={tableData}
...
export default KPIPeriodSummaryPage
