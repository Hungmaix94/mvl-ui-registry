...
import CalendarDayButton from '../../../ui/calendar/calendar-button.tsx'
import { Button, buttonVariants } from '../../../ui/calendar/button.tsx'
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn('relative shadow-xs rounded-md', defaultClassNames.dropdown_root),
      ...
      components={{
        ...
        DayButton: (props: ComponentProps<typeof DayButton>) => (
          <CalendarDayButton {...props} size={'default'} />
        ),
